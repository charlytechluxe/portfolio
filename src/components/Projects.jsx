...
const Card = ({ children, className }) => (
    <div className={`bg-white/70 dark:bg-neutral-900/60 border border-black/5 dark:border-white/5 rounded-[2rem] backdrop-blur-md hover:border-black/10 dark:hover:border-white/10 transition-all duration-300 hover:shadow-2xl dark:hover:shadow-black/50 relative overflow-hidden ${className}`}>
        {children}
    </div>
);
...
const Projects = () => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 md:auto-rows-[180px]">
            ...
            {/* Award Card */}
            <Card className="md:col-span-1 md:row-span-2 group h-[380px] md:h-auto overflow-hidden">
                <div className={`absolute inset-0 bg-gradient-to-br ${awards[0].color} opacity-5 dark:opacity-10 group-hover:opacity-10 dark:group-hover:opacity-20 transition-opacity duration-500`} />
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/40 dark:via-white/10 to-transparent -translate-x-full group-hover:animate-shimmer" />
            ...
            <Card className="md:col-span-1 md:row-span-1 p-6 flex flex-col justify-center gap-4">
                ...
                <a href="/assets/CV.pdf" target="_blank" rel="noopener noreferrer" className="mt-2 text-sm text-center py-2 bg-black/5 dark:bg-white/10 hover:bg-black/10 dark:hover:bg-white/20 rounded-lg transition-colors border border-black/5 dark:border-white/10 flex items-center justify-center gap-2 text-neutral-800 dark:text-white">
            ...
            {/* App Showcase Slider */}
            <Card className="md:col-span-2 md:row-span-2 group relative h-[450px] md:h-auto overflow-hidden">
                        ...
                        <div className="mt-4 md:mt-6 flex justify-center translate-y-16 md:translate-y-12 md:group-hover:translate-y-6 transition-transform duration-500">
                            <div className="w-48 h-64 md:w-56 md:h-72 bg-neutral-100 dark:bg-black rounded-t-[2rem] md:rounded-t-[2.5rem] border-[4px] md:border-[6px] border-white dark:border-neutral-700 shadow-2xl relative overflow-hidden">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center">
                                    ...
                                    <span className="text-neutral-400 dark:text-white/40 text-[10px] font-mono tracking-widest uppercase">
